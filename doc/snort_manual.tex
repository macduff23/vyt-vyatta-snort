...
sequence packet is received. To ensure unlimited decompression, it is suggested 
to set the 'compress\_depth' and 'decompress\_depth' to its maximum values. The
decompression in a single packet is still limited by the 'compress\_depth' and
'decompress\_depth'.
